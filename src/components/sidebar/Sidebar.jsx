    ...
    <div className="sidebar">
      <div className="sidebarWrapper">
        ...
        <div className="sidebarMenu">
          ...
          <ul className="sidebarList">
            <li className="sidebarListItem active"><PermIdentity className="sidebarIcon" />Users</li>
        ...
        <div className="sidebarMenu">
          ...
          <ul className="sidebarList">
            <li className="sidebarListItem active"><MailOutline className="sidebarIcon" />Mail</li>
        ...
        <div className="sidebarMenu">
          ...
          <ul className="sidebarList">
            <li className="sidebarListItem active"><WorkOutline className="sidebarIcon" />Manage</li>
            <li className="sidebarListItem"><Timeline className="sidebarIcon" />Analytics</li>
